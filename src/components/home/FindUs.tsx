...
const FindUs = ({ title, info, image1, image2 }: FindUsProps) => {
  return (
    <div className="bg-vsa-yellow-100 flex flex-col items-start justify-center p-20">
      <div className="text-vsa-brown font-vsa-main p-4 pl-52 text-left text-5xl font-bold">
        {title}
      </div>
      <div className="text-vsa-brown font-vsa-alt p-4 pl-52 text-left text-2xl">
        {info}
      </div>
