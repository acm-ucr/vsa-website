...
const Landing = () => {
  return (
    <div  className="bg-vsa-yellow-100 relative flex h-full w-full items-center justify-center overflow-hidden">
      ...
      <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration: 1.5}} className="font-vsa-main absolute mb-10 flex h-full w-full flex-col items-center py-15 text-center font-extrabold">
