...
const MajorEventsHeader = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-2 py-8 text-center md:gap-8 md:px-4">
      <div className="text-vsa-green-300 font-vsa-main text-3xl font-semibold sm:text-5xl md:text-6xl">
        Our Major Events
      </div>

      <div className="text-vsa-brown font-vsa-alt w-9/10 text-sm sm:w-4/5 md:text-3xl">
      ...
      <Image
        ...
        className="flex w-1/3 object-contain md:w-5/12"
      />
    </div>
  );
};
